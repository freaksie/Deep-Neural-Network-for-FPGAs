    ...
    , TOP{this, namep}
{
    ...
    for (int __Vfinal = 0; __Vfinal < 2; ++__Vfinal) {
        ...
        __Vscope_test.varInsert(__Vfinal,"divid", &(TOP.test__DOT__divid), false, VLVT_UINT32,VLVD_NODIR|VLVF_PUB_RW,1 ,17,0);
        ...
        __Vscope_test.varInsert(__Vfinal,"multi", &(TOP.test__DOT__multi), false, VLVT_UINT64,VLVD_NODIR|VLVF_PUB_RW,1 ,63,0);
        __Vscope_test.varInsert(__Vfinal,"normalized", &(TOP.test__DOT__normalized), false, VLVT_UINT32,VLVD_NODIR|VLVF_PUB_RW,1 ,31,0);
        ...
        __Vscope_test.varInsert(__Vfinal,"sum", &(TOP.test__DOT__sum), false, VLVT_UINT32,VLVD_NODIR|VLVF_PUB_RW,1 ,31,0);
