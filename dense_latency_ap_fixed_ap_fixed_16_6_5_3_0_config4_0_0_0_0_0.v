...
reg  signed [DATA_WIDTH - 1:0] tmp_1_reg_4017;
reg  signed [DATA_WIDTH - 1:0] tmp_17_0_1_reg_4022;
reg  signed [DATA_WIDTH - 1:0] tmp_17_0_2_reg_4027;
reg  signed [DATA_WIDTH - 1:0] tmp_4_reg_4032;
reg  signed [DATA_WIDTH - 1:0] tmp_17_1_reg_4037;
reg  signed [DATA_WIDTH - 1:0] tmp_7_reg_4042;
reg  signed [DATA_WIDTH - 1:0] tmp_17_1_2_reg_4047;
reg  signed [DATA_WIDTH - 1:0] tmp_17_1_3_reg_4052;
reg  signed [DATA_WIDTH - 1:0] tmp_s_reg_4057;
reg  signed [DATA_WIDTH - 1:0] tmp_17_2_1_reg_4062;
reg  signed [DATA_WIDTH - 1:0] tmp_17_2_2_reg_4067;
reg  signed [DATA_WIDTH - 1:0] tmp_17_2_3_reg_4072;
reg  signed [DATA_WIDTH - 1:0] tmp_3_reg_4077;
reg  signed [DATA_WIDTH - 1:0] tmp_17_3_1_reg_4082;
reg  signed [DATA_WIDTH - 1:0] tmp_17_3_2_reg_4087;
reg  signed [DATA_WIDTH - 1:0] tmp_17_3_3_reg_4092;
reg  signed [DATA_WIDTH - 1:0] tmp_9_reg_4097;
reg  signed [DATA_WIDTH - 1:0] tmp_17_4_1_reg_4102;
reg  signed [DATA_WIDTH - 1:0] tmp_11_reg_4107;
reg  signed [DATA_WIDTH - 1:0] tmp_13_reg_4112;
reg  signed [DATA_WIDTH - 1:0] tmp_17_5_reg_4117;
reg  signed [DATA_WIDTH - 1:0] tmp_17_5_1_reg_4122;
reg  signed [DATA_WIDTH - 1:0] tmp_17_5_2_reg_4127;
reg  signed [DATA_WIDTH - 1:0] tmp_15_reg_4132;
reg  signed [DATA_WIDTH - 1:0] tmp_17_6_reg_4137;
reg  signed [DATA_WIDTH - 1:0] tmp_18_reg_4142;
reg  signed [DATA_WIDTH - 1:0] tmp_19_reg_4147;
reg  signed [DATA_WIDTH - 1:0] tmp_21_reg_4152;
reg  signed [DATA_WIDTH - 1:0] tmp_17_7_reg_4157;
reg  signed [DATA_WIDTH - 1:0] tmp_24_reg_4162;
reg  signed [DATA_WIDTH - 1:0] tmp_26_reg_4167;
...
reg   signed [DATA_WIDTH - 1:0] tmp_23_fu_3725_p4;
...
reg signed [DATA_WIDTH - 1:0] node2_0;
reg signed [DATA_WIDTH - 1:0] node2_1;
reg signed [DATA_WIDTH - 1:0] node2_2;
reg signed [DATA_WIDTH - 1:0] node2_3;
reg signed [DATA_WIDTH - 1:0] node3_0;
reg signed [DATA_WIDTH - 1:0] node3_1;
reg signed [DATA_WIDTH - 1:0] node3_2;
reg signed [DATA_WIDTH - 1:0] node3_3;
reg signed [DATA_WIDTH - 1:0] node4_0;
reg signed [DATA_WIDTH - 1:0] node4_1;
reg signed [DATA_WIDTH - 1:0] node4_2;
reg signed [DATA_WIDTH - 1:0] node4_3;
reg signed [DATA_WIDTH - 1:0] node5_0;
reg signed [DATA_WIDTH - 1:0] node5_1;
reg signed [DATA_WIDTH - 1:0] node5_2;
reg signed [DATA_WIDTH - 1:0] node5_3;
reg signed [DATA_WIDTH - 1:0] node6_0;
reg signed [DATA_WIDTH - 1:0] node6_1;
reg signed [DATA_WIDTH - 1:0] node6_2;
reg signed [DATA_WIDTH - 1:0] node6_3;
reg signed [DATA_WIDTH - 1:0] node7_0;
reg signed [DATA_WIDTH - 1:0] node7_1;
reg signed [DATA_WIDTH - 1:0] node7_2;
reg signed [DATA_WIDTH - 1:0] node7_3;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_ce_reg) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        ...
        //Multipliers
        tmp_11_reg_4107 <= {{r_V_8_4_2_fu_196_p2[DSPOUT_WIDTH - 1:DSPOUT_WIDTH-DATA_WIDTH]}};
        node4_2 <= tmp_11_reg_4107;
        tmp_13_reg_4112 <= {{r_V_8_4_3_fu_207_p2[DSPOUT_WIDTH - 1:DSPOUT_WIDTH-DATA_WIDTH]}};
        node4_3 <= tmp_13_reg_4112;
        tmp_15_reg_4132 <= {{r_V_8_5_3_fu_194_p2[DSPOUT_WIDTH - 1:DSPOUT_WIDTH-DATA_WIDTH]}};
        node5_3 <= tmp_15_reg_4132;
        tmp_17_0_1_reg_4022 <= {{r_V_8_0_1_fu_215_p2[DSPOUT_WIDTH - 1:DSPOUT_WIDTH-DATA_WIDTH]}};
        node0_1 <= tmp_17_0_1_reg_4022;
        tmp_17_0_2_reg_4027 <= {{r_V_8_0_2_fu_197_p2[DSPOUT_WIDTH - 1:DSPOUT_WIDTH-DATA_WIDTH]}};
        node0_2 <= tmp_17_0_2_reg_4027;
        tmp_17_1_2_reg_4047 <= {{r_V_8_1_2_fu_210_p2[DSPOUT_WIDTH - 1:DSPOUT_WIDTH-DATA_WIDTH]}};
        node1_2 <= tmp_17_1_2_reg_4047;
        tmp_17_1_3_reg_4052 <= {{r_V_8_1_3_fu_219_p2[DSPOUT_WIDTH - 1:DSPOUT_WIDTH-DATA_WIDTH]}};
        node1_3 <= tmp_17_1_3_reg_4052;
        tmp_17_1_reg_4037 <= {{r_V_8_1_fu_223_p2[DSPOUT_WIDTH - 1:DSPOUT_WIDTH-DATA_WIDTH]}};
        node1_0 <= tmp_17_1_reg_4037;
        tmp_17_2_1_reg_4062 <= {{r_V_8_2_1_fu_204_p2[DSPOUT_WIDTH - 1:DSPOUT_WIDTH-DATA_WIDTH]}};
        node2_1 <= tmp_17_2_1_reg_4062;
        tmp_17_2_2_reg_4067 <= {{r_V_8_2_2_fu_212_p2[DSPOUT_WIDTH - 1:DSPOUT_WIDTH-DATA_WIDTH]}};
        node2_2 <= tmp_17_2_2_reg_4067;
        tmp_17_2_3_reg_4072 <= {{r_V_8_2_3_fu_217_p2[DSPOUT_WIDTH - 1:DSPOUT_WIDTH-DATA_WIDTH]}};
        node2_3 <=  tmp_17_2_3_reg_4072;
        tmp_17_3_1_reg_4082 <= {{r_V_8_3_1_fu_202_p2[DSPOUT_WIDTH - 1:DSPOUT_WIDTH-DATA_WIDTH]}};
        node3_1 <= tmp_17_3_1_reg_4082;
        tmp_17_3_2_reg_4087 <= {{r_V_8_3_2_fu_214_p2[DSPOUT_WIDTH - 1:DSPOUT_WIDTH-DATA_WIDTH]}};
        node3_2 <= tmp_17_3_2_reg_4087;
        tmp_17_3_3_reg_4092 <= {{r_V_8_3_3_fu_198_p2[DSPOUT_WIDTH - 1:DSPOUT_WIDTH-DATA_WIDTH]}};
        node3_3 <= tmp_17_3_3_reg_4092;
        tmp_17_4_1_reg_4102 <= {{r_V_8_4_1_fu_216_p2[DSPOUT_WIDTH - 1:DSPOUT_WIDTH-DATA_WIDTH]}};
        node4_1 <= tmp_17_4_1_reg_4102;
        tmp_17_5_1_reg_4122 <= {{r_V_8_5_1_fu_208_p2[DSPOUT_WIDTH - 1:DSPOUT_WIDTH-DATA_WIDTH]}};
        node5_1 <= tmp_17_5_1_reg_4122;
        tmp_17_5_2_reg_4127 <= {{r_V_8_5_2_fu_206_p2[DSPOUT_WIDTH - 1:DSPOUT_WIDTH-DATA_WIDTH]}};
        node5_2 <= tmp_17_5_2_reg_4127;
        tmp_17_5_reg_4117 <= {{r_V_8_5_fu_195_p2[DSPOUT_WIDTH - 1:DSPOUT_WIDTH-DATA_WIDTH]}};
        node5_0 <= tmp_17_5_reg_4117;
        tmp_17_6_reg_4137 <= {{r_V_8_6_fu_211_p2[DSPOUT_WIDTH - 1:DSPOUT_WIDTH-DATA_WIDTH]}};
        node6_0 <= tmp_17_6_reg_4137;
        tmp_17_7_reg_4157 <= {{r_V_8_7_fu_205_p2[DSPOUT_WIDTH - 1:DSPOUT_WIDTH-DATA_WIDTH]}};
        node7_0 <= tmp_17_7_reg_4157;
        tmp_18_reg_4142 <= {{r_V_8_6_1_fu_3636_p2[DSPOUT_WIDTH - 1:DSPOUT_WIDTH-DATA_WIDTH]}};
        node6_1 <= tmp_18_reg_4142;
        tmp_19_reg_4147 <= {{r_V_8_6_2_fu_193_p2[DSPOUT_WIDTH - 1:DSPOUT_WIDTH-DATA_WIDTH]}};
        node6_2 <= tmp_19_reg_4147;
        tmp_1_reg_4017 <= {{r_V_8_fu_221_p2[DSPOUT_WIDTH - 1:DSPOUT_WIDTH-DATA_WIDTH]}};
        node0_0 <= tmp_1_reg_4017;
        tmp_21_reg_4152 <= {{r_V_8_6_3_fu_200_p2[DSPOUT_WIDTH - 1:DSPOUT_WIDTH-DATA_WIDTH]}};
        node6_3 <= tmp_21_reg_4152;
        tmp_24_reg_4162 <= {{r_V_8_7_2_fu_218_p2[DSPOUT_WIDTH - 1:DSPOUT_WIDTH-DATA_WIDTH]}};
        node7_2 <= tmp_24_reg_4162;
        tmp_26_reg_4167 <= {{r_V_8_7_3_fu_222_p2[DSPOUT_WIDTH - 1:DSPOUT_WIDTH-DATA_WIDTH]}};
        node7_3 <= tmp_26_reg_4167;
        tmp_3_reg_4077 <= {{r_V_8_3_fu_192_p2[DSPOUT_WIDTH - 1:DSPOUT_WIDTH-DATA_WIDTH]}};
        node3_0 <= tmp_3_reg_4077;
        tmp_4_reg_4032 <= {{r_V_8_0_3_fu_3292_p2[DSPOUT_WIDTH - 1:DSPOUT_WIDTH-DATA_WIDTH]}};
        node0_3 <= tmp_4_reg_4032;
        tmp_7_reg_4042 <= {{r_V_8_1_1_fu_203_p2[DSPOUT_WIDTH - 1:DSPOUT_WIDTH-DATA_WIDTH]}};
        node1_1 <= tmp_7_reg_4042;
        tmp_9_reg_4097 <= {{r_V_8_4_fu_3507_p2[DSPOUT_WIDTH - 1:DSPOUT_WIDTH-DATA_WIDTH]}};
        node4_0 <= tmp_9_reg_4097;
        tmp_s_reg_4057 <= {{r_V_8_2_fu_213_p2[DSPOUT_WIDTH - 1:DSPOUT_WIDTH-DATA_WIDTH]}};
        node2_0 <= tmp_s_reg_4057;
        tmp_23_fu_3725_p4 <= {{r_V_8_7_1_fu_3719_p2[DSPOUT_WIDTH - 1:DSPOUT_WIDTH-DATA_WIDTH]}};
